{
  ...
  inputs = {
    nixpkgs.url = "github:NixOS/nixpkgs/e86120df5ca5ae75a94e8ce5b74bfdf89b1bc1e7";
    emacs-overlay.url = "github:nix-community/emacs-overlay/5148f0e35c9b884eec954113941c4292f60e55fa";
